...
/*
  ...
  3) Compile:
        g++ -std=gnu++11 -c LPD8806.cpp
        g++ -std=gnu++11 -c raspberry.cpp
        g++ -std=gnu++11 -o raspberry raspberry.o LPD8806.o -lwiringPi
        sudo ./raspberry
*/
...
const uint16_t numberOfPixels = 240;

// Set the first variable to the NUMBER of pixels. 32 = 32 pixels in a row
// The LED strips are 32 LEDs per meter but you can extend/cut the strip
// LPD8806 strip(32, dataPin, clockPin);
LPD8806 strip(&gpioLockMutex, numberOfPixels, dataPin, clockPin);
